    ...
    try:
        if data == "start":
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton('ᴜᴩᴅᴀᴛᴇꜱ', url='https://telegram.me/dotzbaikk'),
                     InlineKeyboardButton('ꜱᴜᴩᴩᴏʀᴛ', url='https://telegram.me/dotzsupport')],
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton('💥 ʀᴇᴘᴏ', url='https://github.com/bendotz/String-Session-Bot'),
